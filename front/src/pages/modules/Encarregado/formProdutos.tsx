...
<div className="max-w-2xl mx-auto bg-white p-16 rounded-md shadow-md">
    ...
    <div className="grid gap-6 mb-6 lg:grid-cols-2">
        <div>
            <label htmlFor="salGrosso" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sal Grosso</label>
        ...
        <div>
            <label htmlFor="salFino" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sal Fino</label>
        ...
        <div>
            <label htmlFor="metabissulfito" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Metabissulfito</label>
        ...
        <div>
            <label htmlFor="peroxido" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Peroxido</label>
        ...
        <div>
            <label htmlFor="bombonas" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bombonas</label>
