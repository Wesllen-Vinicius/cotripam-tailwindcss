...
<div className="max-w-2xl mx-auto bg-white p-16 rounded-md shadow-md">
    ...
    <div className="grid gap-6 mb-6 lg:grid-cols-2">
        <div>
            <label htmlFor="total" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Total do Abate</label>
        ...
        <div>
            <label htmlFor="condenados" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Condenados</label>
