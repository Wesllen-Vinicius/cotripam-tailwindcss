  ...
  return (
        <div>
          <div className="max-w-2xl mx-auto py-16 px-0 sm:py-24  lg:max-w-7xl ">
            <h2 className="text-2xl font-extrabold tracking-tight text-gray-900">Conheça Nossos Produtos!</h2>
    
            <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6  xl:grid-cols-4 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
              {products.map((product) => (
                <div key={product.id} className="group relative bg-white p-4 rounded-md shadow-md">
